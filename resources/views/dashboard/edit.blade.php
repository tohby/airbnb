                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control myform" id="inputPassword4"
                                placeholder="Lagos, Nigeria" name="apartmentAddress" value="{{$room->apartmentAddress}}>
                                        </div>
                                    </div>
                            ...
                            <select id="Details" class="form-control myform" name="apartmentAmenities" value="{{$room->apartmentAmenities}}>
                                ...
                                <input type="text" class="form-control myform" id="inputAddress2"
                                    placeholder="Apartment, studio, or floor" name="apartmentRules" value="{{$room->apartmentRules}}>
                                    </div>
                                    <div class=" form-group">
